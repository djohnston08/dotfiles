...
hs.hotkey.bind(mash, 'l', function() hs.window.focusedWindow():move(M.units.right30,    nil, true) end)
hs.hotkey.bind(mash, 'h', function() hs.window.focusedWindow():move(M.units.left70,     nil, true) end)
...
hs.hotkey.bind(mash, ']', function() hs.window.focusedWindow():move(M.units.upright30,  nil, true) end)
hs.hotkey.bind(mash, '[', function() hs.window.focusedWindow():move(M.units.upleft70,   nil, true) end)
hs.hotkey.bind(mash, ';', function() hs.window.focusedWindow():move(M.units.botleft70,  nil, true) end)
hs.hotkey.bind(mash, "'", function() hs.window.focusedWindow():move(M.units.botright30, nil, true) end)
